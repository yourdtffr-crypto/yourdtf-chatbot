    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{
            ...
            fontSize: 16, color: 'var(--text)', letterSpacing: '-0.3px',
          }}>YourDTF</div>
        ...
        {!started && (
          <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <div style={{ fontSize: 15, color: 'var(--text-muted)', fontWeight: 300 }}>
                Comment puis-je t'aider avec tes impressions DTF ?
              </div>
            </div>
      ...
      <div style={{
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              boxShadow: input.trim() && !loading ? '0 4px 12px rgba(255,61,0,0.3)' : 'none',
            }}
          >
        ...
        <div style={{
          ...
          fontSize: 11, color: '#444', fontFamily: 'var(--font-body)',
        }}>
